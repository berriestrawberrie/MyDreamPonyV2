    <div class="w-full flex justify-evenly  mb-4 ">
        <div class="w-2/5 border relative">
            <h2 id="item_name3" class="bg-sky-100 text-lg font-bold 
            text-center rounded-2xl p-2 mb-2">Item Name</h2>
            <div class="p-4">
                <span class="font-bold">Description: </span><p class="inline p-2" id="item_desc3">--</p>
            </div>
            <div id="tags_3">
        ...
        <!--SINGLE ITEM IMAGE-->
        <div>
            <img id="single-img3" src="{{asset('site/blankitem.png')}}">
        </div>

</div>
    <div class="flex justify-center flex-wrap gap-4">
    @for($i=0; $i<count($group); $i++)
        @if(in_array($group[$i]["itemtype"],['Mouth','Ears','Hair','Base','Top','Bottom','Set']))
            ...
            onclick="changeDisplay3({{$group[$i]["itemid"]}})" 
